...
public class VendingMachineServiceImpl implements IVendingMachineService 
{
    ...
    private final IVmTypeService vmTypeService;
    private final IChannelService channelService;
    @Autowired
    public VendingMachineServiceImpl(VendingMachineMapper vendingMachineMapper, INodeService nodeService, IVmTypeService vmTypeService, IChannelService channelService) {
        this.vendingMachineMapper = vendingMachineMapper;
        this.nodeService = nodeService;
        this.vmTypeService = vmTypeService;
